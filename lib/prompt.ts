export const BACHELORETTE_TEMPLATE =
  'Write an email to [To] to see if they are willing to contribute to a bachelorette trip to [destination]. Make it sound genuine and no hyphen. Make it personable by including a funny story about [name of bride] and saying the [To] in a joke or play on word. Include that I am willing to share/post to socials. Keep it short but personable. End with a pun.';
